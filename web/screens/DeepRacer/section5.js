  ...
  return (
    <Grid container spacing={3} className={classes.section_5}>
      ...
      <Grid item xl={10} lg={10} md={10} sm={10} xs={12}>
        <h2>Compete in the AWS DeepRacer League</h2>
        <p>
          Once you have built your model, it’s time to race! The AWS DeepRacer
      ...
      <Grid item xl={4} lg={4} md={4} sm={4} xs={12}>
        ...
        <h3>AWS Virtual Circuit</h3>
        <p>Race online</p>
        <p>
          Join the global AWS DeepRacer League. Compete in time trial races and
      ...
      <Grid item xl={4} lg={4} md={4} sm={4} xs={12}>
        ...
        <p>
          AWS DeepRacer Enterprise events are the fastest way to get your
      ...
      <Grid item xl={7} lg={7} md={7} sm={7} xs={12}>
        <h3>NEW | AWS DeepRacer LIVE races</h3>
        <p>host your own worldwide race broadcast</p>
        <p>
          With new AWS DeepRacer LIVE races anyone can set up a race in minutes

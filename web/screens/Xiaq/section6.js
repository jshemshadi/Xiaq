  ...
  return (
    <Grid container spacing={3} className={classes.section_6}>
      ...
      <Grid item xl={7} lg={7} md={7} sm={7} xs={12}>
        ...
        <p>
          Xiaq is an autonomous 1/18th scale race car designed to test
      ...
      <Grid item xl={7} lg={7} md={7} sm={7} xs={12}>
        <h3>Introducing the Xiaq Evo</h3>
        <p>
          Xiaq Evo is the next generation in autonomous racing. It
          ...
          Xiaq on the same track and try to avoid it while still turning in
      ...
      <Grid item xl={7} lg={7} md={7} sm={7} xs={12}>
        <h3>Already own an Xiaq?</h3>
        <p>
          Developers who already own a Xiaq can upgrade their cars to have
          the same capabilities as Evo with the Xiaq Sensor Kit.
        </p>
        <Grid container style={{ display: "flex" }}>
          <Grid
            item
